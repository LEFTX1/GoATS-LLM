...
func (m *MockChatClient) WithTools(tools []*schema.ToolInfo) (model.ToolCallingChatModel, error) {
	log.Printf("[MockChatClient] WithTools called with %d tools. Delegating to BindTools.", len(tools))
